...
The eventual frontend will warn: "Draft 4 conflict: an Isle with a Nesting Beast cannot have a Market." That warning is **not** part of this server/domain body and is **not VERIFIED**.
...
| Nesting Beast relocation semantics | *(earlier commit)* | M5.4 UX B2: add Nesting Beast relocation semantics |
| Market + Nest representable state | *(this commit)* | M5.4 UX B2: represent Market and Nest conflicts |
