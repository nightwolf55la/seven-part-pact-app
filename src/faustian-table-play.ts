 ...
 * approved Faustian common-play gestures: Devil Deck Scheme supply drag,
 * Faustian Deck Blackmail supply drag, and object-attached context actions.
 *
...
export const FAUSTIAN_BLACKMAIL_SUPPLY_KIND = "faustian_blackmail_supply";
