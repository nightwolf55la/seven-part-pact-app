...
function playState(overrides: Record<string, unknown> = {}): any {
  ...
  return {
    ...
    wizards: [
      { wizardId: WIZ1, name: "W1", portrayedByPlayerId: PLR1, character: { ...BLANK_WIZARD_CHARACTER }, homeIsleId: null, sanctumPlaceId: null, mortalityState: "not_deceased" },
      { wizardId: WIZ2, name: "W2", portrayedByPlayerId: null, character: { ...BLANK_WIZARD_CHARACTER }, homeIsleId: null, sanctumPlaceId: null, mortalityState: "not_deceased" },
    ],
    lifecycle: {
      kind: "play",
      phase: "new_moon",
