...
describe("Checkpoint verification", () => {
  ...
  it("passes for valid checkpoint", () => {
    const errors = verifyCheckpoint({
      ...
      campaignRevision: 10,
      snapshotExists: true,
      snapshotState: { schemaVersion: 5, ruleset: { id: "seven_part_pact_draft4", version: 1 }, calendar: { monthOrdinal: 3 }, configuration: { ageId: null, facilitatorPlayerId: null }, players: [], wizards: [], pactSeats: { necromancer: { status: null, wizardId: null, watcherPlayerId: null }, hierophant: { status: null, wizardId: null, watcherPlayerId: null }, warlock: { status: null, wizardId: null, watcherPlayerId: null }, mariner: { status: null, wizardId: null, watcherPlayerId: null }, faustian: { status: null, wizardId: null, watcherPlayerId: null }, sage: { status: null, wizardId: null, watcherPlayerId: null }, sorcerer: { status: null, wizardId: null, watcherPlayerId: null } }, pactFragmentOperationalState: { necromancer: { condition: "intact", custody: { kind: "none" } }, hierophant: { condition: "intact", custody: { kind: "none" } }, warlock: { condition: "intact", custody: { kind: "none" } }, mariner: { condition: "intact", custody: { kind: "none" } }, faustian: { condition: "intact", custody: { kind: "none" } }, sage: { condition: "intact", custody: { kind: "none" } }, sorcerer: { condition: "intact", custody: { kind: "none" } } }, lifecycle: { kind: "setup", orrery: { saturn: null, jupiter: null, mars: null, venus: null, mercury: null } }, wizardmootHistory: [], world: { denizens: [], isles: [], places: [], companionRelationships: [], campaignPowerfulDenizenTaxonomies: [], treasures: [] }, hierophant: { selectedFlameLawIds: [], campaignClasses: [], campaignDoctrines: [], temples: [], supplicants: [], prophets: [], cults: [], holidayTempleIds: [] }, mariner: { shipPlaceId: null, selectedLawOfSeaIds: [], boardIsles: [], routes: [], seaRegions: [], beasts: [] }, necromancer: { gates: [], pathSpaces: [], steps: [], souls: [], foes: [], allies: [], ghoulCallers: [], selectedLaws: [], depth: null, wizardTraversals: [] },
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, lore: EMPTY_LORE_STATE, },
...
describe("verifyCheckpointRestoreRevision", () => {
  ...
  const validInput = {
    ...
    sourceSnapshotState: { schemaVersion: 5, ruleset: { id: "seven_part_pact_draft4", version: 1 }, calendar: { monthOrdinal: 3 }, configuration: { ageId: null, facilitatorPlayerId: null }, players: [], wizards: [], pactSeats: { necromancer: { status: null, wizardId: null, watcherPlayerId: null }, hierophant: { status: null, wizardId: null, watcherPlayerId: null }, warlock: { status: null, wizardId: null, watcherPlayerId: null }, mariner: { status: null, wizardId: null, watcherPlayerId: null }, faustian: { status: null, wizardId: null, watcherPlayerId: null }, sage: { status: null, wizardId: null, watcherPlayerId: null }, sorcerer: { status: null, wizardId: null, watcherPlayerId: null } }, pactFragmentOperationalState: { necromancer: { condition: "intact", custody: { kind: "none" } }, hierophant: { condition: "intact", custody: { kind: "none" } }, warlock: { condition: "intact", custody: { kind: "none" } }, mariner: { condition: "intact", custody: { kind: "none" } }, faustian: { condition: "intact", custody: { kind: "none" } }, sage: { condition: "intact", custody: { kind: "none" } }, sorcerer: { condition: "intact", custody: { kind: "none" } } }, lifecycle: { kind: "setup", orrery: { saturn: null, jupiter: null, mars: null, venus: null, mercury: null } }, wizardmootHistory: [], world: { denizens: [], isles: [], places: [], companionRelationships: [], campaignPowerfulDenizenTaxonomies: [], treasures: [] }, hierophant: { selectedFlameLawIds: [], campaignClasses: [], campaignDoctrines: [], temples: [], supplicants: [], prophets: [], cults: [], holidayTempleIds: [] }, mariner: { shipPlaceId: null, selectedLawOfSeaIds: [], boardIsles: [], routes: [], seaRegions: [], beasts: [] }, necromancer: { gates: [], pathSpaces: [], steps: [], souls: [], foes: [], allies: [], ghoulCallers: [], selectedLaws: [], depth: null, wizardTraversals: [] },
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, lore: EMPTY_LORE_STATE, } as any,
    resultSnapshotExists: true,
    resultSnapshotState: { schemaVersion: 5, ruleset: { id: "seven_part_pact_draft4", version: 1 }, calendar: { monthOrdinal: 3 }, configuration: { ageId: null, facilitatorPlayerId: null }, players: [], wizards: [], pactSeats: { necromancer: { status: null, wizardId: null, watcherPlayerId: null }, hierophant: { status: null, wizardId: null, watcherPlayerId: null }, warlock: { status: null, wizardId: null, watcherPlayerId: null }, mariner: { status: null, wizardId: null, watcherPlayerId: null }, faustian: { status: null, wizardId: null, watcherPlayerId: null }, sage: { status: null, wizardId: null, watcherPlayerId: null }, sorcerer: { status: null, wizardId: null, watcherPlayerId: null } }, pactFragmentOperationalState: { necromancer: { condition: "intact", custody: { kind: "none" } }, hierophant: { condition: "intact", custody: { kind: "none" } }, warlock: { condition: "intact", custody: { kind: "none" } }, mariner: { condition: "intact", custody: { kind: "none" } }, faustian: { condition: "intact", custody: { kind: "none" } }, sage: { condition: "intact", custody: { kind: "none" } }, sorcerer: { condition: "intact", custody: { kind: "none" } } }, lifecycle: { kind: "setup", orrery: { saturn: null, jupiter: null, mars: null, venus: null, mercury: null } }, wizardmootHistory: [], world: { denizens: [], isles: [], places: [], companionRelationships: [], campaignPowerfulDenizenTaxonomies: [], treasures: [] }, hierophant: { selectedFlameLawIds: [], campaignClasses: [], campaignDoctrines: [], temples: [], supplicants: [], prophets: [], cults: [], holidayTempleIds: [] }, mariner: { shipPlaceId: null, selectedLawOfSeaIds: [], boardIsles: [], routes: [], seaRegions: [], beasts: [] }, necromancer: { gates: [], pathSpaces: [], steps: [], souls: [], foes: [], allies: [], ghoulCallers: [], selectedLaws: [], depth: null, wizardTraversals: [] },
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, lore: EMPTY_LORE_STATE, } as any,
  ...
  it("rejects result snapshot differing from source snapshot", () => {
    const errors = verifyCheckpointRestoreRevision({
      ...validInput,
      resultSnapshotState: { schemaVersion: 5, ruleset: { id: "seven_part_pact_draft4", version: 1 }, calendar: { monthOrdinal: 99 }, configuration: { ageId: null, facilitatorPlayerId: null }, players: [], wizards: [], pactSeats: { necromancer: { status: null, wizardId: null, watcherPlayerId: null }, hierophant: { status: null, wizardId: null, watcherPlayerId: null }, warlock: { status: null, wizardId: null, watcherPlayerId: null }, mariner: { status: null, wizardId: null, watcherPlayerId: null }, faustian: { status: null, wizardId: null, watcherPlayerId: null }, sage: { status: null, wizardId: null, watcherPlayerId: null }, sorcerer: { status: null, wizardId: null, watcherPlayerId: null } }, pactFragmentOperationalState: { necromancer: { condition: "intact", custody: { kind: "none" } }, hierophant: { condition: "intact", custody: { kind: "none" } }, warlock: { condition: "intact", custody: { kind: "none" } }, mariner: { condition: "intact", custody: { kind: "none" } }, faustian: { condition: "intact", custody: { kind: "none" } }, sage: { condition: "intact", custody: { kind: "none" } }, sorcerer: { condition: "intact", custody: { kind: "none" } } }, lifecycle: { kind: "setup", orrery: { saturn: null, jupiter: null, mars: null, venus: null, mercury: null } }, wizardmootHistory: [], world: { denizens: [], isles: [], places: [], companionRelationships: [], campaignPowerfulDenizenTaxonomies: [], treasures: [] }, hierophant: { selectedFlameLawIds: [], campaignClasses: [], campaignDoctrines: [], temples: [], supplicants: [], prophets: [], cults: [], holidayTempleIds: [] }, mariner: { shipPlaceId: null, selectedLawOfSeaIds: [], boardIsles: [], routes: [], seaRegions: [], beasts: [] }, necromancer: { gates: [], pathSpaces: [], steps: [], souls: [], foes: [], allies: [], ghoulCallers: [], selectedLaws: [], depth: null, wizardTraversals: [] },
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, lore: EMPTY_LORE_STATE, } as any,
    });
