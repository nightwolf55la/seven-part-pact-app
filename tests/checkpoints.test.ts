...
describe("Checkpoint verification", () => {
  ...
  it("passes for valid checkpoint", () => {
    ...
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, },
...
describe("verifyCheckpointRestoreRevision", () => {
  ...
  const validInput = {
    ...
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, magicConsumables: EMPTY_MAGIC_CONSUMABLES_STATE, sorcerer: EMPTY_SORCERER_STATE, } as any,
