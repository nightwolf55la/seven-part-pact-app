...
describe("Checkpoint verification", () => {
  ...
  it("passes for valid checkpoint", () => {
    ...
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, },
...
describe("verifyCheckpointRestoreRevision", () => {
  ...
  const validInput = {
    ...
    faustian: EMPTY_FAUSTIAN_STATE, sage: EMPTY_SAGE_STATE, warlock: EMPTY_WARLOCK_STATE, } as any,
