...
const M3_COMMAND_EVENT_MAP: Record<string, { required: string[]; optional?: string[] }> = {
  ...
  initialize_hierophant_source_setup: { required: ["hierophant_initialized"] },
  ...
  convert_hierophant_hestar_resource: { required: ["hierophant_hestar_resource_converted"] },
  steer_hierophant_supplicant: { required: ["hierophant_supplicant_steered"] },
  depart_hierophant_supplicant_with_benefaction: { required: ["hierophant_supplicant_benefaction_departed"] },
  ...
  update_prophet: { required: ["prophet_updated"] },
  remove_prophet: { required: ["prophet_removed"] },
  establish_cult: { required: ["cult_established"] },
  update_cult: { required: ["cult_updated"] },
  remove_cult: { required: ["cult_removed"] },
  add_cult_dogma: { required: ["cult_dogma_added"] },
  update_cult_dogma: { required: ["cult_dogma_updated"] },
  remove_cult_dogma: { required: ["cult_dogma_removed"] },
  create_campaign_class: { required: ["campaign_class_created"] },
  ...
  initialize_mariner_source_setup: { required: ["mariner_initialized"] },
  ...
  create_mariner_beast: { required: ["mariner_beast_created"] },
  move_mariner_storm: { required: ["mariner_storm_moved"] },
  move_mariner_ship: { required: ["mariner_ship_moved"] },
  ...
  set_necromancer_soul_count: { required: ["necromancer_soul_count_changed"] },
  move_necromancer_souls: { required: ["necromancer_souls_moved"] },
  add_necromancer_foe: { required: ["necromancer_foe_added"] },
  update_necromancer_foe: { required: ["necromancer_foe_updated"] },
  remove_necromancer_foe: { required: ["necromancer_foe_removed"] },
  escape_necromancer_wizard_foe: { required: ["necromancer_wizard_foe_escaped"] },
  add_necromancer_wizard_foe_truth: { required: ["necromancer_wizard_foe_truth_added"] },
  update_necromancer_wizard_foe_truth: { required: ["necromancer_wizard_foe_truth_updated"] },
  remove_necromancer_wizard_foe_truth: { required: ["necromancer_wizard_foe_truth_removed"] },
  ...
  add_necromancer_ghoul_caller: { required: ["necromancer_ghoul_caller_added"] },
  update_necromancer_ghoul_caller: { required: ["necromancer_ghoul_caller_updated"] },
  remove_necromancer_ghoul_caller: { required: ["necromancer_ghoul_caller_removed"] },
  create_necromancer_campaign_gate: { required: ["necromancer_campaign_gate_created"] },
  update_necromancer_campaign_gate: { required: ["necromancer_campaign_gate_updated"] },
  create_necromancer_campaign_path_space: { required: ["necromancer_campaign_path_space_created"] },
  remove_necromancer_campaign_path_space: { required: ["necromancer_campaign_path_space_removed"] },
  add_necromancer_step: { required: ["necromancer_step_added"] },
  remove_necromancer_step: { required: ["necromancer_step_removed"] },
  set_wizard_mortality_state: { required: ["wizard_mortality_state_changed"] },
  set_denizen_mortality_state: { required: ["denizen_mortality_state_changed"] },
  create_powerful_denizen_profile: { required: ["powerful_denizen_profile_created"] },
  remove_powerful_denizen_profile: { required: ["powerful_denizen_profile_removed"] },
  set_powerful_denizen_taxonomies: { required: ["powerful_denizen_taxonomies_changed"] },
  set_powerful_denizen_status: { required: ["powerful_denizen_status_changed"] },
  set_powerful_denizen_goal: { required: ["powerful_denizen_goal_changed"] },
  add_powerful_denizen_method: { required: ["powerful_denizen_method_added"] },
  update_powerful_denizen_method: { required: ["powerful_denizen_method_updated"] },
  remove_powerful_denizen_method: { required: ["powerful_denizen_method_removed"] },
  add_powerful_denizen_truth: { required: ["powerful_denizen_truth_added"] },
  update_powerful_denizen_truth: { required: ["powerful_denizen_truth_updated"] },
  remove_powerful_denizen_truth: { required: ["powerful_denizen_truth_removed"] },
  create_campaign_powerful_denizen_taxonomy: { required: ["campaign_powerful_denizen_taxonomy_created"] },
  update_campaign_powerful_denizen_taxonomy: { required: ["campaign_powerful_denizen_taxonomy_updated"] },
  remove_campaign_powerful_denizen_taxonomy: { required: ["campaign_powerful_denizen_taxonomy_removed"] },
  create_treasure: { required: ["treasure_created"] },
  update_treasure_details: { required: ["treasure_details_updated"] },
  update_treasure_state: { required: ["treasure_state_updated"] },
  ...
  record_faustian_scheme_occurred: { required: ["faustian_scheme_occurred"] },
  disclose_faustian_twist: { required: ["faustian_twist_disclosed"] },
  record_faustian_twist_occurred: { required: ["faustian_twist_occurred"] },
  record_faustian_machination_outcome: { required: ["faustian_machination_outcome_recorded"] },
  complete_faustian_machination_response: { required: ["faustian_machination_response_completed"] },
  finalize_faustian_machination_challenge: { required: ["faustian_machination_challenge_finalized"] },
  correct_faustian_card: { required: ["faustian_card_corrected"] },
  correct_faustian_antagonist: { required: ["faustian_antagonist_corrected"] },
  correct_faustian_demon: { required: ["faustian_demon_corrected"] },
  correct_faustian_domain_seizure: { required: ["faustian_domain_seizure_corrected"] },
  correct_faustian_devil_profile: { required: ["faustian_devil_profile_corrected"] },
  record_faustian_due_month_obligation: { required: ["faustian_due_month_obligation_recorded"] },
  fulfill_faustian_due_month_obligation: { required: ["faustian_due_month_obligation_fulfilled"] },
  correct_faustian_persistent_effect: { required: ["faustian_persistent_effect_corrected"] },
  ...
  tutor_sorcerer_student: { required: ["sorcerer_student_tutored"] },
  rearrange_sorcerer_tower: { required: ["sorcerer_tower_rearranged"] },
  set_sorcerer_researcher_operational_this_month: { required: ["sorcerer_researcher_operational_this_month_changed"] },
  adjust_sorcerer_knowledge: { required: ["sorcerer_knowledge_adjusted"] },
  set_sorcerer_archives_open: { required: ["sorcerer_archives_open_changed"] },
  move_sorcerer_tower_magic_consumable: { required: ["sorcerer_tower_magic_consumable_moved"] },
  set_sorcerer_researcher_production_multipliers: { required: ["sorcerer_researcher_production_multipliers_set"] },
  set_sorcerer_laws: { required: ["sorcerer_laws_set"] },
  create_sorcerer_campaign_definition: { required: ["sorcerer_campaign_definition_created"] },
  update_sorcerer_campaign_definition: { required: ["sorcerer_campaign_definition_updated"] },
  add_sorcerer_arcanist: { required: ["sorcerer_arcanist_added"] },
  update_sorcerer_arcanist: { required: ["sorcerer_arcanist_updated"] },
  add_sorcerer_construct: { required: ["sorcerer_construct_added"] },
  set_sorcerer_construct_instructions: { required: ["sorcerer_construct_instructions_set"] },
  add_sorcerer_innovation: { required: ["sorcerer_innovation_added"] },
  revise_sorcerer_innovation: { required: ["sorcerer_innovation_revised"] },
  remove_sorcerer_innovation: { required: ["sorcerer_innovation_removed"] },
